...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50/30 via-white to-amber-50/20">
      ...
      {showPopup && (
        <div className="animate-in fade-in fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-4 backdrop-blur-md duration-300">
          <div className="animate-in zoom-in-95 relative w-full max-w-md overflow-hidden rounded-2xl bg-white shadow-2xl duration-300">
            <div className="absolute top-0 right-0 left-0 h-32 bg-gradient-to-br from-[#5C2E0B] to-[#8B4513]" />
            <button
            ...
            <div className="relative pt-16 pb-6 text-center">
              <div className="mx-auto mb-4 flex h-20 w-20 items-center justify-center rounded-full bg-gradient-to-br from-amber-400 to-amber-600 shadow-lg">
                <Sparkles className="h-10 w-10 text-white" />
              </div>
              <h2 className="font-serif text-2xl font-bold text-gray-900">Custom Design Service</h2>
            ...
            <div className="border-t border-gray-100 bg-amber-50/30 p-6">
              ...
              <button
                onClick={() => setShowPopup(false)}
                className="group relative w-full overflow-hidden rounded-xl bg-gradient-to-r from-[#5C2E0B] to-[#8B4513] py-3.5 font-semibold text-white transition-all hover:shadow-lg"
              >
      ...
      {/* --- HERO SECTION --- */}
      <section className="relative overflow-hidden bg-gradient-to-br from-[#5C2E0B] via-[#8B4513] to-[#D2691E] py-28 text-white">
        <div className="absolute inset-0">
          <div className="absolute top-0 right-0 h-96 w-96 rounded-full bg-amber-500/20 blur-3xl" />
        ...
        <div className="relative container mx-auto px-6 text-center">
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <h1 className="mb-6 font-serif text-5xl font-bold tracking-tight lg:text-7xl">
              ...
              <span className="block text-amber-300">Beautiful Together</span>
            </h1>
            ...
            <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
              ...
              <span className="text-sm text-amber-200">Trusted by 10,000+ happy customers</span>
            </div>
          </div>
        </div>
      ...
      <div className="container mx-auto -mt-12 px-6 pb-24">
        <div className="grid gap-8 lg:grid-cols-3">
          ...
          <div className="space-y-6 pt-16 lg:col-span-1">
            <div className="rounded-2xl bg-gradient-to-br from-[#5C2E0B] to-[#8B4513] p-8 text-white shadow-xl">
              <h3 className="mb-4 font-serif text-2xl font-bold">Get in Touch</h3>
              <p className="mb-6 text-amber-100">We'd love to hear from you. Reach out anytime!</p>
                ...
                {[
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-sm text-amber-100">{item.content}</p>
                    </div>
                  </a>
                ))}
              </div>
            ...
            {/* Trust Badge */}
            <div className="rounded-2xl border border-gray-200 bg-gradient-to-r from-amber-50 to-amber-100/50 p-6 text-center">
              <Award className="mx-auto mb-3 h-10 w-10 text-[#8B4513]" />
              <p className="text-sm font-semibold text-[#8B4513]">5-Year Color Guarantee</p>
              <p className="mt-1 text-xs text-gray-500">Quality you can trust</p>
            </div>
          </div>
            ...
            <div className="rounded-2xl border border-gray-200 bg-white/95 p-8 shadow-xl backdrop-blur-sm lg:p-12">
              ...
              <form onSubmit={handleSubmit} className="grid gap-6">
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="group relative overflow-hidden rounded-xl bg-gradient-to-r from-[#5C2E0B] to-[#8B4513] px-8 py-4 font-bold text-white shadow-lg transition-all hover:shadow-xl disabled:opacity-50"
                >
                ...
                <p className="text-center text-xs text-gray-500">
                  ...
                  <Link href="/privacy" className="text-[#8B4513] underline">
                    Privacy Policy
                  </Link>
                </p>
              </form>
        ...
        <div className="mt-24">
          <div className="mb-12 text-center">
            <div className="mb-4 inline-flex items-center gap-2 rounded-full bg-amber-100 px-4 py-2">
              ...
              <span className="text-sm font-medium text-[#8B4513]">FAQ</span>
            </div>
            <h2 className="font-serif text-3xl font-bold text-[#5C2E0B] md:text-4xl">
            ...
            {[
              ...
              >
                <div className="flex items-start justify-between gap-4">
                  <h3 className="text-lg font-bold text-[#5C2E0B]">{faq.q}</h3>
                  <ChevronRight className="h-5 w-5 text-gray-400 transition-transform group-hover:translate-x-1 group-hover:text-[#8B4513]" />
                </div>
        ...
        {/* --- SOCIAL SECTION --- */}
        <div className="mt-24 overflow-hidden rounded-2xl bg-gradient-to-br from-[#5C2E0B] to-[#8B4513] p-12 text-center text-white shadow-2xl">
          <div className="relative z-10">
            <h2 className="mb-4 font-serif text-3xl font-bold">Follow Our Journey</h2>
            <p className="mb-8 text-amber-100">
              Join our community of 50,000+ handloom enthusiasts
            </p>
          ...
          {[
            ...
            >
              ...
              <div className="relative">
                <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-amber-50 to-amber-100 text-[#8B4513] transition-all group-hover:scale-110">
